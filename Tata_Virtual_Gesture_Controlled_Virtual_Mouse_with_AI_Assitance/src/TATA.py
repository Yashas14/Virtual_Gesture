...
def check_battery_status():
    ...
    if battery:
        ...
        if plugged:
            reply(f"The battery is at {percent}% and is currently charging.")
        else:
            reply(f"The battery is at {percent}% and is not charging.")
    else:
        reply("Sorry, I couldn't retrieve the battery status.")
